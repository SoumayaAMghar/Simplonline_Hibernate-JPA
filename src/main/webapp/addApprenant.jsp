...
<body>
<%
    List<Promos> promoList = (List<Promos>) request.getAttribute("promosList");
                            ...
                            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                ...
                                <div class="flex justify-center w-full ">
                                    <div class="w-11/12 md:w-3/4 sm-3/4 lg:w-1/2 bg-white rounded shadow-2xl p-8 m-4">
                                        <h1 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">ADD Apprenant</h1>
                                        <form action="${pageContext.request.contextPath}/CrudApprenant/addApprenant" method="post">
                                            ...
                                            <div class="flex flex-col mb-4">
                                                ...
                                                <input class="border py-2 px-3 text-grey-800" type="text" name="email" id="email" required>
                                            </div>
                                            <div class="flex flex-col mb-4">
                                                <label class="mb-2 font-bold text-lg text-gray-900" for="password">Password</label>
                                                <input class="border py-2 px-3 text-grey-800" type="text" name="password" id="password" required>
                                            </div>
                                            <div class="flex flex-col mb-4">
                                                <label class="mb-2 font-bold text-lg text-gray-900" >Promotion</label>
                                                <select name="promotion">
                                                    <option selected value="null"></option>
                                                    <%
                                                    for (Promos promos: promoList){
                                                    %>
                                                    <option value="<%= promos.getId() %>"   ><%= promos.getName() %></option>
                                                    <%}%>
                                                </select>
<%--                                                <input class="border py-2 px-3 text-grey-800" type="text" name="promotion" id="promotion" >--%>
                                            </div>
