...
<div class="h-screen bg-gradient-to-br from-blue-600 to-indigo-600 flex justify-center items-center w-full">
    <form action="${pageContext.request.contextPath}/Admin/DashboardAdmin" method="post">
        <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full" name="email" id="email" />
                </div>
                <div>
                    <label for="password" class="block mb-1 text-gray-600 font-semibold">Password</label>
                    <input type="password" class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full" name="password" id="password"/>
                </div>
            </div>
