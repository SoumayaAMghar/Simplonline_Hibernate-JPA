        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8">
                    <h3 class="text-gray-700 text-3xl font-medium">Promotions</h3>
                    <div class="mt-8">
                        <a href="${pageContext.request.contextPath}/CrudPromotion/addPromo" class="fas fa-plus text-white mb-4 bg-indigo-600 rounded p-2 mt-2">Add Promotion</a>
                    </div>
                        ...
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    %>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200"><%=promos.getName()%></td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200"><%=promos.getFormateurId()%></td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                            <div class="flex space-x-2">
                                                <form action="${pageContext.request.contextPath}/PromotionServlet" method="post">
                                                ...
                                                <form method="post" action="${pageContext.request.contextPath}/CrudPromotion/deletePromotion" class="mr-1">
                                                    <input type="hidden" name="id" value="<%=promos.getId()%>">
