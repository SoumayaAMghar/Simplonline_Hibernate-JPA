                            ...
                            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                ...
                                <div class="flex justify-center w-full ">
                                    <div class="w-11/12 md:w-3/4 sm-3/4 lg:w-1/2 bg-white rounded shadow-2xl p-8 m-4">
                                        <h1 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">Update Apprenant</h1>
                                        <form action="${pageContext.request.contextPath}/CrudApprenant/updateApprenant" method="post">
                                            <div class="flex flex-col mb-4">
                                                <label class="mb-2 font-bold text-lg text-gray-900" for="firstname">Firstname</label>
                                                <input class="border py-2 px-3 text-grey-800" type="text" name="firstname" id="firstname" value="<%=selectedApprenant.getFirstname()%>">
                                            </div>
                                            <div class="flex flex-col mb-4">
                                                <label class="mb-2 font-bold text-lg text-gray-900" for="lastname">Lastname</label>
                                                <input class="border py-2 px-3 text-grey-800" type="text" name="lastname" id="lastname" value="<%=selectedApprenant.getLastname()%>">
                                            </div>
                                            <div class="flex flex-col mb-4">
                                                <label class="mb-2 font-bold text-lg text-gray-900" for="email">Email</label>
                                                <input class="border py-2 px-3 text-grey-800" type="text" name="email" id="email" value="<%=selectedApprenant.getEmail()%>">
                                            </div>
                                            <div class="flex flex-col mb-4">
                                                <label class="mb-2 font-bold text-lg text-gray-900" for="password">Password</label>
                                                <input class="border py-2 px-3 text-grey-800" type="text" name="password" id="password" value="<%=selectedApprenant.getPassword()%>">
                                            </div>
                                            <div class="flex flex-col mb-4">
                                                <label class="mb-2 font-bold text-lg text-gray-900" for="promotion">Promotion</label>
                                                <input class="border py-2 px-3 text-grey-800" type="text" name="promotion" id="promotion" value="<%=selectedApprenant.getPassword()%>">
                                            </div>
                                            <div class="pt-4 flex items-center justify-center">
                                                <a class="flex justify-center items-center w-40 text-gray-900 px-4 py-3 rounded-md focus:outline-none" href="${pageContext.request.contextPath}/CrudApprenant/displayApprenant">
...
<%--                                                <input type="hidden" name="action" value="updateFormateur"/>--%>
                                                <button type="submit"  class="bg-indigo-500 w-40 text-white px-4 py-3 rounded-md focus:outline-none">Update</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
